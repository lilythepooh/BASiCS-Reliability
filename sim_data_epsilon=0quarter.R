...
#set data path to where you store the non-regression BASiCS synthetic data
#and where you would like to store your posteriors
#from modified non-regression BASiCS with epsilon=0
