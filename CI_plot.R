...
colnames(out_CI89)<-c("out_CI89","less_than_lowCI89","more_than_highCI89")
out_CI50<-matrix(0,nrow=n_run,ncol=3)
colnames(out_CI50)<-c("out_CI50","less_than_lowCI50","more_than_highCI50")
for (index_run in (1:n_run)){
  ...
  less_than_low89<-length(which(delta1<ci_hdi_delta_low_89))
  more_than_high89<-length(which(delta1>ci_hdi_delta_high_89))
  out_CI89[index_run,1]<-less_than_low89+more_than_high89
  out_CI89[index_run,2]<-less_than_low89
  out_CI89[index_run,3]<-more_than_high89
  more_than_high50<-length(which(delta1>ci_hdi_delta_high_50))
  less_than_low50<-length(which(delta1<ci_hdi_delta_low_50))
  out_CI50[index_run,1]<-more_than_high50+less_than_low50
  out_CI50[index_run,2]<-less_than_low50
  out_CI50[index_run,3]<-more_than_high50
  write.table(out_CI89,"out_CI89.txt")
  write.table(out_CI50,"out_CI50.txt")
