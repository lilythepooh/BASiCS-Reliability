...
#set data path to where you store the non-regression BASiCS data(fixed dataset)
#and where you would like to store your result from 
#epsilon=1, modified non-regression BASiCS MCMC
